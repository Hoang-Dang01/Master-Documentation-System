...
MDS không hướng tới việc loại bỏ 100% mọi sai sót phát sinh trong tương lai. Mục tiêu tối thượng của MDS là đảm bảo chúng ta không bao giờ bỏ quên các khía cạnh trọng yếu của hệ thống:
...
### Rule Zero — Every new abstraction must solve a real pain
...
- Discovery, BA docs,          - Đăng ký thực thể (Registries). - Hộp ngữ cảnh (Context).
