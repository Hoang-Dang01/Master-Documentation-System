...
> **Sứ mệnh:** Định nghĩa quy chuẩn bắt buộc cho bộ hồ sơ ngữ cảnh nền tảng (Project Profiles) tại thư mục `projects/active/` nhằm thiết lập ranh giới nghiệp vụ, mục tiêu kinh doanh, ràng buộc tối cao và cấu hình chế độ vận hành cho dự án trước khi vận hành.
...
Mọi dự án vận hành trên hệ điều hành MDS bắt buộc phải định nghĩa và duy trì bộ hồ sơ sau ở trạng thái phê duyệt (`APPROVED`) tại thư mục `projects/active/`:
